...
function render(variables = {}) {
  ...
  let socialMediaPos = "right";
  if (variables.socialMediaPosition !== "right") {
    socialMediaPos = variables.socialMediaPosition;
  }
  ...
  let role = null;
  if (variables.role !== null) role = variables.name;

  let city = null;
  if (variables.city !== null) city = variables.twitter;

  let country = null;
  if (variables.country !== null) country = variables.name;
